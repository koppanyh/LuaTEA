--[[
  ...
  The Tiny Encryption Algorithm implemented in vanilla Lua by Koppany Horvath.
  Algorithm derived from https://en.wikipedia.org/wiki/Tiny_Encryption_Algorithm.
  Modified for 16 bit block size and 32 bit key size
  This code is under the MIT license and is free to use, modify, etc with proper acknowledgement.
  
  The v parameter on encrypt and decrypt should be a table with 2 "8 bit" numbers.
  The k parameter on encrypt and decrypt should be a table with 4 "8 bit" numbers.
  
  The to8 and bxor functions are required by the encrypt and decrypt functions.
  The other functions add a simple interface for working with strings.
